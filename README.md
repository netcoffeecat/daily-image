...
<p align="center">
  <img src="https://raw.githubusercontent.com/netcoffeecat/daily-image/refs/heads/page/daily.webp" alt="Daily Bing Wallpaper" width="600" />
</p>
...
- 运行 `main.py` 获取并保存壁纸。
- 将图片和网页内容推送到 `page` 分支。
- 使用 GitHub Pages 公开展示（`https://netcoffeecat.github.io/daily-image/`）。
...
1. **随机图 API**：
   - 访问 `[https://ccn.94v.net/api/random` 获取随机壁纸。
   - 可在网页中直接使用，如：`<img src="https://ccn.94v.net/api/random" alt="随机壁纸" />`。
